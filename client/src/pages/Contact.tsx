      ...
      <div className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-display font-bold mb-16">
            Contact <span className="text-[#fed337]">Us</span>
          </h1>
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl font-bold mb-6 flex items-center">
                  <Mail className="text-[#fed337] mr-4" /> Email Us
                </h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-6 flex items-center">
                  <Phone className="text-[#fed337] mr-4" /> Call Us
                </h3>
                <p className="text-gray-400 mb-2">24/7 Support Line</p>
                <a href="tel:+15551234567" className="text-xl hover:text-[#fed337] transition-colors">91+ 9136060001</a>
              </div>

              <div>
                <h3 className="text-2xl font-bold mb-6 flex items-center">
                  <MapPin className="text-[#fed337] mr-4" /> Visit Us
                </h3>
